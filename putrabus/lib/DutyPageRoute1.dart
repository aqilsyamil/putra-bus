...
//         padding: EdgeInsets.only(top: 0.0, right: 16.0, bottom: 16.0, left: 0.0), // Adjust top and right padding
...
class _DutyPageRoute1State extends State<DutyPageRoute1> {
  ...
  void _initializeRouteData() async {
    ...
    // final busLocationIcon =
    // await getResizedMarkerIcon('assets/images/bus_location_tracker.png', 60, 60);
